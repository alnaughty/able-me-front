<template>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 py-40 px-20">
    <div>
      <p class="text-4xl font-bold uppercase mb-7">A Letter from the <br> <span class="text-purple">Founders</span> of Able Me</p>
      <p class="text-[18px]">We founded Able Me with a shared vision and a deep sense <br>
